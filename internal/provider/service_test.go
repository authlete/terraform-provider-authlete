		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("authlete_service.complete_described", "supported_documents.0", "idcard"),
					resource.TestCheckResourceAttr("authlete_service.complete_described", "supported_documents.1", "password"),
