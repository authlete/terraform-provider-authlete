		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("authlete_client.client1", "redirect_uris.0", "https://www.authlete.com/cb"),
					resource.TestCheckResourceAttr("authlete_client.client1", "redirect_uris.1", "http://localhost:3000/cb"),
