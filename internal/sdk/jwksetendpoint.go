...
// JWKSetEndpoint - API endpoints for to generate JSON Web Key Set (JWKS) for a service.
...
func newJWKSetEndpoint(rootSDK *Authlete, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *JWKSetEndpoint {
...
func (s *JWKSetEndpoint) ServiceJwksGetAPI(ctx context.Context, request operations.ServiceJwksGetAPIRequest, opts ...operations.Option) (*operations.ServiceJwksGetAPIResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.ServiceJwksGetResponse
