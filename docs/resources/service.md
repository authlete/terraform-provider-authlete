...
- `attributes` (Block Set) (see [below for nested schema](#nestedblock--attribute))
...
- `attributes` (Block Set) (see [below for nested schema](#nestedblock--supported_scopes--attribute))
